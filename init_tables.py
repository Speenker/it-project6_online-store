...
def reset_database():
    # Если скрипт большой, лучше вынести в отдельный .sql файл и читать его с encoding='utf-8'
    sql_path = os.path.join(os.path.dirname(__file__), 'init_tables.sql')
    if os.path.exists(sql_path):
        with open(sql_path, 'r', encoding='utf-8') as f:
            ddl_dml_script = f.read()
    # else:
    #     # fallback: если sql-файл не найден, используем строку (сюда можно вставить SQL вручную)
    #     ddl_dml_script = """
